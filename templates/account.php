...
<div class="card shadow-sm mb-3 d-lg-none">
  <div class="card-body">
    <div class="fw-semibold mb-1"><i class="bi bi-info-circle me-2" aria-hidden="true"></i>About</div>
    <div class="text-muted small mb-2">Karaoke OS is a lightweight karaoke library for browsing and tracking plays.</div>
